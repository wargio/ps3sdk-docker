...
#define HAVE_fmsv4sf4 1
#define HAVE_fmadf4 1
#define HAVE_fmav2df4 1
#define HAVE_fmsdf4 1
#define HAVE_fmsv2df4 1
#define HAVE_nfmadf4 1
#define HAVE_nfmav2df4 1
#define HAVE_nfmsdf4 1
#define HAVE_nfmsv2df4 1
...
#define HAVE_fnmadf4 (!HONOR_SIGNED_ZEROS (DFmode))
#define HAVE_fnmav2df4 (!HONOR_SIGNED_ZEROS (V2DFmode))
#define HAVE_fnmsdf4 (!HONOR_SIGNED_ZEROS (DFmode))
#define HAVE_fnmsv2df4 (!HONOR_SIGNED_ZEROS (V2DFmode))
...
#define HAVE_dftsv 1
#define HAVE_vcondv16qiv16qi 1
#define HAVE_vcondv8hiv8hi 1
#define HAVE_vcondv4siv4si 1
#define HAVE_vcondv4sfv4sf 1
#define HAVE_vcondv2dfv2df 1
#define HAVE_vconduv16qiv16qi 1
#define HAVE_vconduv8hiv8hi 1
#define HAVE_vconduv4siv4si 1
...
extern rtx        gen_floatunstisf2             (rtx, rtx);
...
extern rtx        gen_cgt_ti_m1                 (rtx, rtx);
...
extern rtx        gen_floattisf2                (rtx, rtx);
