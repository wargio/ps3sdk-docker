...
#else
  const char *x_spu_arch_string;
#define spu_arch_string global_options.x_spu_arch_string
#endif
#ifdef GENERATOR_FILE
extern int spu_branch_cost;
#else
  int x_spu_branch_cost;
#define spu_branch_cost global_options.x_spu_branch_cost
#endif
#ifdef GENERATOR_FILE
extern int spu_dual_nops;
#else
  int x_spu_dual_nops;
#define spu_dual_nops global_options.x_spu_dual_nops
#endif
#ifdef GENERATOR_FILE
extern int spu_ea_model;
#else
  int x_spu_ea_model;
#define spu_ea_model global_options.x_spu_ea_model
#endif
#ifdef GENERATOR_FILE
extern const char *spu_fixed_range_string;
#else
  const char *x_spu_fixed_range_string;
#define spu_fixed_range_string global_options.x_spu_fixed_range_string
#endif
#ifdef GENERATOR_FILE
extern const char *spu_max_distance_str;
#else
  const char *x_spu_max_distance_str;
#define spu_max_distance_str global_options.x_spu_max_distance_str
#endif
#ifdef GENERATOR_FILE
extern int spu_max_nops;
#else
  int x_spu_max_nops;
#define spu_max_nops global_options.x_spu_max_nops
#endif
#ifdef GENERATOR_FILE
extern const char *spu_tune_string;
#else
  const char *x_spu_tune_string;
#define spu_tune_string global_options.x_spu_tune_string
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_matomic_updates;
#define x_VAR_matomic_updates do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mcache_size_;
#define x_VAR_mcache_size_ do_not_use
#endif
#ifndef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_maddress_space_conversion = 980,       /* -maddress-space-conversion */
  OPT_march_ = 981,                          /* -march= */
  OPT_matomic_updates = 982,                 /* -matomic-updates */
  OPT_mbranch_cost_ = 983,                   /* -mbranch-cost= */
  OPT_mbranch_hints = 984,                   /* -mbranch-hints */
  OPT_mcache_size_ = 985,                    /* -mcache-size= */
  OPT_mdual_nops = 986,                      /* -mdual-nops */
  OPT_mdual_nops_ = 987,                     /* -mdual-nops= */
  OPT_mea32 = 988,                           /* -mea32 */
  OPT_mea64 = 989,                           /* -mea64 */
  OPT_merror_reloc = 990,                    /* -merror-reloc */
  OPT_mfixed_range_ = 991,                   /* -mfixed-range= */
  OPT_mhint_max_distance_ = 992,             /* -mhint-max-distance= */
  OPT_mhint_max_nops_ = 993,                 /* -mhint-max-nops= */
  OPT_mlarge_mem = 994,                      /* -mlarge-mem */
  OPT_msafe_dma = 995,                       /* -msafe-dma */
  OPT_msafe_hints = 996,                     /* -msafe-hints */
  OPT_msmall_mem = 997,                      /* -msmall-mem */
  OPT_mstdmain = 998,                        /* -mstdmain */
  OPT_mtune_ = 999,                          /* -mtune= */
  OPT_munsafe_dma = 1000,                    /* -munsafe-dma */
  OPT_mwarn_reloc = 1001,                    /* -mwarn-reloc */
  OPT_n = 1002,                              /* -n */
